...
export type OrderManyWhereInput = {
  ...
  paymentStatus?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  paymentStatus_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  paymentStatus_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  paymentStatus_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  paymentStatus_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  paymentStatus_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  paymentStatus_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  paymentStatus_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  paymentStatus_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  paymentStatus_starts_with?: InputMaybe<Scalars['String']['input']>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type ProductManyWhereInput = {
  ...
  averageRating?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  averageRating_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  averageRating_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  averageRating_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  averageRating_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  averageRating_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  averageRating_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  averageRating_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  averageRating_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  averageRating_starts_with?: InputMaybe<Scalars['String']['input']>;
...
export type CollectionGetListQuery = { collections: Array<{ id: string, slug: string, name: string, image: { height?: number | null, width?: number | null, url: string } }> };
...
export type CollectionGetByIdQuery = { collection?: { name: string, description?: string | null, products: Array<{ id: string, name: string, price: number, slug: string, description: string, averageRating?: string | null, categories: Array<{ name: string, id: string, slug: string }>, images: Array<{ height?: number | null, width?: number | null, url: string }> }> } | null };

export type GetCategoryProductsCountQueryVariables = Exact<{
  slug: Scalars['String']['input'];
}>;


export type GetCategoryProductsCountQuery = { categories: Array<{ products: Array<{ id: string }> }> };
...
export type GetProductBySlugQuery = { product?: { id: string, name: string, price: number, description: string, slug: string, averageRating?: string | null, images: Array<{ url: string }>, categories: Array<{ name: string, slug: string }>, collections: Array<{ id: string, name: string, slug: string }>, reviews: Array<{ id: string, headline: string, content: string, rating?: number | null, name: string, email: string }>, variants: Array<{ id: string, name: string } | { id: string, name: string, color: ProductColor, size: ProductSize } | { id: string, name: string, size: ProductSize }> } | null };
...
export type OrderUpdatePaymentStatusMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  paymentStatus: Scalars['String']['input'];
}>;


export type OrderUpdatePaymentStatusMutation = { updateOrder?: { id: string } | null };

export type OrderUpdateUserMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  userId: Scalars['String']['input'];
}>;


export type OrderUpdateUserMutation = { updateOrder?: { id: string } | null };
...
export type OrdersGetByEmailQuery = { orders: Array<{ id: string, stage: Stage, total: number, createdAt: unknown, paymentStatus?: string | null, orderItems: Array<{ product?: { id: string, name: string, images: Array<{ url: string }> } | null }> }> };
...
export type GetProductByIdQuery = { product?: { id: string, name: string, price: number, description: string, slug: string, averageRating?: string | null, images: Array<{ url: string }>, categories: Array<{ name: string, slug: string }>, collections: Array<{ id: string, name: string, slug: string }>, reviews: Array<{ id: string, headline: string, content: string, rating?: number | null, name: string, email: string }>, variants: Array<{ id: string, name: string } | { id: string, name: string, color: ProductColor, size: ProductSize } | { id: string, name: string, size: ProductSize }> } | null };
...
export type ProductGetListQuery = { products: Array<{ id: string, name: string, price: number, slug: string, description: string, averageRating?: string | null, categories: Array<{ name: string, id: string, slug: string }>, images: Array<{ height?: number | null, width?: number | null, url: string }> }> };
...
export type ProductGetListSortByPriceQuery = { products: Array<{ id: string, name: string, price: number, slug: string, description: string, averageRating?: string | null, categories: Array<{ name: string, id: string, slug: string }>, images: Array<{ height?: number | null, width?: number | null, url: string }> }> };
...
export type ProductsCountQuery = { products: Array<{ id: string }> };
...
export type ProductsGetByCategorySlugQuery = { categories: Array<{ products: Array<{ id: string, name: string, price: number, slug: string, description: string, averageRating?: string | null, categories: Array<{ name: string, id: string, slug: string }>, images: Array<{ height?: number | null, width?: number | null, url: string }> }> }> };
...
export type ReviewAddMutation = { review?: { id: string, stage: Stage } | null };

export type ReviewFragmentFragment = { id: string, headline: string, content: string, rating?: number | null, name: string, email: string };

export type ReviewGetByProductSlugQueryVariables = Exact<{
  slug: Scalars['String']['input'];
}>;


export type ReviewGetByProductSlugQuery = { reviews: Array<{ id: string, headline: string, content: string, rating?: number | null, name: string, email: string }> };
...
export type SearchProductsQuery = { products: Array<{ id: string, name: string, price: number, slug: string, description: string, averageRating?: string | null, categories: Array<{ name: string, id: string, slug: string }>, images: Array<{ height?: number | null, width?: number | null, url: string }> }> };

export type SingleProductFragmentFragment = { id: string, name: string, price: number, description: string, slug: string, averageRating?: string | null, images: Array<{ url: string }>, categories: Array<{ name: string, slug: string }>, collections: Array<{ id: string, name: string, slug: string }>, reviews: Array<{ id: string, headline: string, content: string, rating?: number | null, name: string, email: string }>, variants: Array<{ id: string, name: string } | { id: string, name: string, color: ProductColor, size: ProductSize } | { id: string, name: string, size: ProductSize }> };
...
export const GetCategoryProductsCountDocument = new TypedDocumentString(`
  ...
  categories(where: {slug: $slug}) {
    ...
    `) as unknown as TypedDocumentString<GetCategoryProductsCountQuery, GetCategoryProductsCountQueryVariables>;
...
export const OrderUpdatePaymentStatusDocument = new TypedDocumentString(`
    mutation OrderUpdatePaymentStatus($id: ID!, $paymentStatus: String!) {
  updateOrder(data: {paymentStatus: $paymentStatus}, where: {id: $id}) {
    id
  }
}
    `) as unknown as TypedDocumentString<OrderUpdatePaymentStatusMutation, OrderUpdatePaymentStatusMutationVariables>;
export const OrderUpdateUserDocument = new TypedDocumentString(`
    mutation OrderUpdateUser($id: ID!, $userId: String!) {
  updateOrder(data: {userId: $userId}, where: {id: $id}) {
    id
  }
}
    `) as unknown as TypedDocumentString<OrderUpdateUserMutation, OrderUpdateUserMutationVariables>;
...
export const ReviewGetByProductSlugDocument = new TypedDocumentString(`
  ...
  name
  email
}`) as unknown as TypedDocumentString<ReviewGetByProductSlugQuery, ReviewGetByProductSlugQueryVariables>;
